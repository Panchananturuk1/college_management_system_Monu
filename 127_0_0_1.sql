...
-- Database: `contact2`
--
CREATE DATABASE IF NOT EXISTS `contact2` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `contact2`;
...
INSERT INTO `monu` (`id`, `fname`, `lname`) VALUES
(1, 'Monu', 'martinez'),
(5, 'Rocking', 'Monu'),
(26, 'rt', 'rt'),
(27, 'd', 'd'),
...
-- Database: `contact3`
--
CREATE DATABASE IF NOT EXISTS `contact3` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `contact3`;
...
INSERT INTO `contact` (`id`, `fname`, `lname`) VALUES
(1, 'ererre', 'er'),
(2, 'MOnu', 'Martinez'),
(3, 'MOnu', 'Martinez'),
(4, 'fgfg', 'fg'),
...
-- Database: `monu`
--
CREATE DATABASE IF NOT EXISTS `monu` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `monu`;
...
('root', '[{"db":"student","table":"info"},{"db":"contact2","table":"monu"},{"db":"Student","table":"info"},{"db":"contact3","table":"monu"},{"db":"monu","table":"contact"},{"db":"login","table":"contact"},{"db":"test","table":"contact"},{"db":"login","table":"users"}]');
...
('root', '2018-03-13 04:03:10', '{"collation_connection":"utf8mb4_unicode_ci"}');
