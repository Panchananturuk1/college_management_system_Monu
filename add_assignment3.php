                ...
                <div class="font">
                  <nav>
                                <ul>
                                    ...
                                    <li> <a href="add_assignment3.php" class="header_Menu">Add Assignments3</a> </li><br />
    ...
    <div class="box"  >
    <form  method="post" action="add_assignment3.php"    name="myForm" onsubmit="return(validate());"   enctype="multipart/form-data" >
       ...
       <h1 style="text-align:center; font-size:40px;" >Add Assignments</h1><br />
         ...
         <input type="button" class="myfile" name="view" id="submit" value="Submit"  class="submit" />
