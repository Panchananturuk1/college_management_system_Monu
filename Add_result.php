...
<?php 
       ...
       {  
                ...
                //  $myfile =  $_POST['myfile'];
                     ...
                     $destination = 'Faculty/Result/' . $filename;
                     ...
                     if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
                         ...
                         if (move_uploaded_file($file, $destination)) {
                             $sql = "INSERT INTO result (name,Date, size, Department, Semester) 
                             VALUES ('$filename', '$Date', $size, '$Department','$Semester')";
                             if (mysqli_query($conn, $sql)) {
                               echo  '<script> alert("Result Sucessfully Uploaded"); </script>';
                           
                             }
                         } else {
                           echo  '<script> alert("Failed to upload Result."); </script>';
                         }
                     }	
       }  
