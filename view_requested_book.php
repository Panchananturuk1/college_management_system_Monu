...
<form action="view_requested_book.php" method="post"  name="myForm" onsubmit="return(validate());">
<div class="box"  >
      <h1 style="text-align:center; font-size:40px;" >View Requested Book</h1><br />
